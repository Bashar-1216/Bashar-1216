...
<h2>⚙️ Tech Stack</h2>
<table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="border:0;border-collapse:collapse;background:transparent">
  <tr style="border:0;background:transparent">
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=python" width="32" height="32" alt="Python" /><br/><sub>Python</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=pytorch" width="32" height="32" alt="PyTorch" /><br/><sub>PyTorch</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=huggingface" width="32" height="32" alt="Transformers" /><br/><sub>Transformers</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=fastapi" width="32" height="32" alt="FastAPI" /><br/><sub>FastAPI</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=docker" width="32" height="32" alt="Docker" /><br/><sub>Docker</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=postgres" width="32" height="32" alt="PostgreSQL" /><br/><sub>PostgreSQL</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="./assets/icons/qdrant.svg" width="32" height="32" alt="Qdrant" /><br/><sub>Qdrant</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=redis" width="32" height="32" alt="Redis" /><br/><sub>Redis</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=langchain" width="32" height="32" alt="LangChain" /><br/><sub>LangChain</sub></td>
    <td width="10%" align="center" valign="top" nowrap style="border:0;padding:2px 4px;text-align:center;vertical-align:top;background:transparent"><img src="https://skillicons.dev/icons?i=git" width="32" height="32" alt="Git" /><br/><sub>Git</sub></td>
  </tr>
</table>
